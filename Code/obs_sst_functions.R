...
# Main satellite data extraction function ---------------------------------
env_data_extract<- function(data.set = "OISST", dates = NULL, box = c(-77, -60, 35, 46), out.dir = "~/Dropbox/Andrew/Work/GMRI/EnvData/", mask) {
